...
/*  This is too much clutter to work with, should be moved into a seperate file
    //ETHNICITY DROP DOWN
        Image {
            id: ethnicityDrop
    ...
    //PATIENT PAGE SAVE BUTTON
                Button {
                    ...
                    function clickHandler() {
                        patient.setFirstName(firstNameInput.text)
                        patient.setLastName(lastNameInput.text)
                        patient.setVillage(villageInput.text)
                        //patient.setGender(genderSelector.gender)
